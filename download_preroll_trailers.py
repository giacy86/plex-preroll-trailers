...
#trailers_filename = []	#array with the filename of the trailers
...
for k in range(0,max_trailers):
	...
	with youtube_dl.YoutubeDL(ydl_opts) as ydl:
		#ydl.download(['https://www.youtube.com/watch?v='+trailers[k][0]])
		video=ydl.extract_info('https://www.youtube.com/watch?v='+trailers[k][0], download=True)
		filename=ydl.prepare_filename(video)
		#trailers_filename.append(filename.encode('utf8'))
		trailers_filename[k+1] = filename
		#os.symlink(filename, 'trailer_'+str(k))

# Write the filename of the trailers into a file
# with open("preroll_trailers.txt", 'w') as f:
	# for t in trailers_filename:
